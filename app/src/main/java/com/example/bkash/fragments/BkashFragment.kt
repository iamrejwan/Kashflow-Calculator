...
import com.example.bkash.MainActivity
...
class BkashFragment() : Fragment() {

    private val BKASH_CHARGE = 1.75
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        calculateBtn.setOnClickListener(View.OnClickListener { view ->
            title.text = getString(R.string.bkash_cashout_calculator)
            description.text = getString(R.string.cashing_out_from_app_bkash)
            if(amountInput.text!!.isNotEmpty()){
                val charges = calculateCharges(amountInput.text.toString().toInt(), BKASH_CHARGE)
                ...
                itemList3.setText("bkash charges: $BKASH_CHARGE%")
